    ...
    <div class="enterprise-kpi-grid">
        ...
        <div class="enterprise-kpi-card">
            ...
            <div style="display:flex;align-items:baseline;justify-content:space-between;">
                <span id="kpi-total-tasks" style="font-size:28px;font-weight:700;color:#1d1d1f;line-height:1;">
                    {{ $totalTasks }}
                </span>
        ...
        <div class="enterprise-kpi-card">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                ...
                <span id="kpi-progress-percentage" style="font-size:12px;font-weight:600;color:#0066cc;">
                    {{ $progressPercentage }}%
                </span>
            </div>
            <div style="display:flex;align-items:baseline;justify-content:space-between;">
                <span id="kpi-completed-tasks" style="font-size:28px;font-weight:700;color:#0066cc;line-height:1;">
                    {{ $completedTasks }}
                </span>
                <span style="font-size:12px;color:#7a7a7a;">dari <span id="kpi-total-tasks-sub">{{ $totalTasks }}</span></span>
            </div>
        </div>
        ...
        <div class="enterprise-kpi-card">
            ...
            <div style="display:flex;align-items:baseline;justify-content:space-between;">
                <span id="kpi-pending-tasks" style="font-size:28px;font-weight:700;color:#1d1d1f;line-height:1;">
        ...
        <div class="enterprise-kpi-card">
            ...
            <div style="display:flex;align-items:baseline;justify-content:space-between;">
                <span id="kpi-penting-tasks" style="font-size:28px;font-weight:700;color:#ff3b30;line-height:1;">
                    {{ $pentingTasks }}
                </span>
            ...
            @else
                ...
                <div style="display:flex;flex-direction:column;gap:12px;">
                    @foreach ($tasks as $task)
                        <x-task-card :task="$task" :workspace="$workspace" />
                    @endforeach
                </div>
            @endif
                    ...
                    @if(auth()->id() === $workspace->user_id)
                        <div style="padding-top:8px;border-top:1px solid #f0f0f0;margin-top:4px;">
                            <a href="{{ route('workspaces.edit', $workspace) }}"
                               ...
                               style="display:flex;align-items:center;justify-content:center;gap:6px;width:100%;text-decoration:none;font-size:12px;padding:6px 0;">
                                ...
                                <span>Edit Pengaturan Workspace</span>
                            </a>
                        </div>
                    @endif
                </div>
